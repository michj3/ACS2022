...
The data can be obtained at IPUMS USA, [here](https://usa.ipums.org/usa/). We will use ACS 2022 data from IPUMS (CITE) to estimate total respondents for each state. 
